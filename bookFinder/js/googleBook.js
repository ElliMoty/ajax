...
const fetchBookInfo = function (event) { // added event just if we want to start searching by clicking enter instead of using button.
    ...
    xhr.onreadystatechange = function () {
        ...
        // debugger; binding pry will pause server
...
document.querySelector('form').addEventListener('subimt', fetchBookInfo(event));